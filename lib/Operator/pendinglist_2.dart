...
class PendingList_2 extends StatefulWidget {
  final String doc_id;
  const PendingList_2({super.key, required this.doc_id});

  @override
  State<PendingList_2> createState() => _PendingList_2State();
}

class _PendingList_2State extends State<PendingList_2> {
  var name,
      operator_name,
      email,
      phonenumber,
                      ...
                      loading == true
                          ...
                          : Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  CustomButtonCon(
                                    text: "Send File Deletion Request",
                                    onPressed: () async {
                                      setState(() {
                                        loading = true;
                                      });
